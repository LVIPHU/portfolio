  ...
  return (
    <React.Fragment>
      ...
      <Container as={'main'} className={'mb-auto grow pt-14 md:pt-28'}>
        <Header title={'Oop!'} description={t(i18n)`It seems like the page you're looking for doesn't exist! Please go back!`} />
        <div className={'relative h-[50vh] w-full'}>
          <Image src={'/static/images/errors/404.svg'} fill={true} alt={t(i18n)`not found`} className={'object-contain'} />
        </div>
