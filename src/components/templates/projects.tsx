  ...
  return (
    <Container>
      ...
      <div className='py-5 md:py-10'>
        <h3 className='mb-5 text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-gray-100 md:text-3xl'>
          {t(i18n)`Work`}
        </h3>
        <HoverEffect items={workProjects} />
      </div>
      <div className='mt-5 border-t border-gray-200 py-5 dark:border-gray-700 md:mt-10 md:py-10'>
        <h3 className='mb-5 text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-gray-100 md:mb-8 md:text-3xl'>
