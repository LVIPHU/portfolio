/**
 * Copy ảnh/asset từ packages/content/assets → public/content (C5-03, D-08 —
 * port từ apps/2026/scripts). Chạy tự động trước dev/build (predev/prebuild).
 * public/content là thư mục SINH RA — bị wipe mỗi lần sync, đừng sửa tay.
 */
